...
void main() {
  group('DailySubtasksSheet Widget Tests', () {
    ...
    testWidgets('renders list of subtasks independently with parent badge and toggles completion', (
      tester,
    ) async {
      ...
      final checkboxFinder = find.byKey(const ValueKey('subtask_checkbox_sub-1'));
      ...
      final updatedSub = updatedParent.subtaskItems.firstWhere((s) => s.id == 'sub-1');
